            ...
            {cartItems.map((product) => (
              <div key={product.id} className="md:flex items-stretch py-8 md:py-10 lg:py-8 border-t border-gray-50">
                <div className="md:w-4/12 2xl:w-1/4 w-full">
                  <img src={product.image} alt={product.title} className="h-full object-center object-cover md:block hidden" />
                  <img src={product.image} alt={product.title} className="md:hidden w-full h-full object-center object-cover" />
                </div>
